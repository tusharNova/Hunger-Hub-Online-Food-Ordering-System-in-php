...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online Food Ordering System - Hungry-Hub TB</title>
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <h4 class="text-white">Hungry-<span class="text-danger">HUB</span></h4></a>
