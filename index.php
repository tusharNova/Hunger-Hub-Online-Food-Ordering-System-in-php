...
?>
    ...
    <section class="dishes mt-5">
        <div class="container ">
            <div class="display-6 text-center fw-bold h1">Popular Dishes of the Month</div>
            <div class="mt-3 text-enter h3">Easiest way to order your favourite food among these top 6 dishes</div>
                                            ...
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block">
                                                     ...
                                                     <a href="dishes.php?res_id=' . $row['r_id'] . '" class="btn theme-btn-dash float-end">Order Now</a> 
                                                    </div>
                                                </div>
